...
from models.transformer.attention import MultiHeadAttention, MultiHeadAttentionWithTextBox
...
class DecoderLayer(Module):
    def __init__(self, d_model=512, d_k=64, d_v=64, h=8, d_ff=2048, dropout=.1, self_att_module=None,
        ...
        self.enc_att = MultiHeadAttentionWithTextBox(d_model, d_k, d_v, h, dropout, can_be_stateful=False,
